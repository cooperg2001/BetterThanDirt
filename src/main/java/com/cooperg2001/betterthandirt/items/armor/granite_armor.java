...
public class granite_armor extends ArmorItem {
    private EquipmentSlotType SlotType;
    private int DegradeCount = 0;

    public granite_armor(CustomArmorMaterials.CustArmorMaterial mat, EquipmentSlotType type, Item.Properties props) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        if (slot == EquipmentSlotType.LEGS) {
            ...
            return "betterthandirt:textures/models/armor/granite_layer_2.png";

        } else {
            //return path to generic layer one
            return "betterthandirt:textures/models/armor/granite_layer_1.png";
        }
